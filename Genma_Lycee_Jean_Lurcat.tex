...
\hspace{-14cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
\begin{center}
...
{\setbeamertemplate{footline}{
\begin{beamercolorbox}[wd=\paperwidth,ht=1.5ex,dp=20pt,leftskip=.3cm,rightskip=.3cm]{author in head/foot}
\hspace{-12cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
\begin{center}
...
{\setbeamertemplate{footline}{
\begin{beamercolorbox}[wd=\paperwidth,ht=1.5ex,dp=20pt,leftskip=.3cm,rightskip=.3cm]{author in head/foot}
\hspace{-10cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
\begin{center}
...
{\setbeamertemplate{footline}{
\begin{beamercolorbox}[wd=\paperwidth,ht=1.5ex,dp=20pt,leftskip=.3cm,rightskip=.3cm]{author in head/foot}
\hspace{-8cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
\begin{center}
...
{\setbeamertemplate{footline}{
\begin{beamercolorbox}[wd=\paperwidth,ht=1.5ex,dp=20pt,leftskip=.3cm,rightskip=.3cm]{author in head/foot}
\hspace{-6cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
\begin{center}
\Huge{Le pseudonymat}
...
{\setbeamertemplate{footline}{
\begin{beamercolorbox}[wd=\paperwidth,ht=1.5ex,dp=20pt,leftskip=.3cm,rightskip=.3cm]{author in head/foot}
\hspace{-4cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
\begin{center}
...
{\setbeamertemplate{footline}{
\begin{beamercolorbox}[wd=\paperwidth,ht=1.5ex,dp=20pt,leftskip=.3cm,rightskip=.3cm]{author in head/foot}
\hspace{-3cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
\begin{center}
...
{\setbeamertemplate{footline}{
\begin{beamercolorbox}[wd=\paperwidth,ht=1.5ex,dp=20pt,leftskip=.3cm,rightskip=.3cm]{author in head/foot}
\hspace{-2cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
...
{\setbeamertemplate{footline}{
\begin{beamercolorbox}[wd=\paperwidth,ht=1.5ex,dp=20pt,leftskip=.3cm,rightskip=.3cm]{author in head/foot}
\hspace{+1cm}{\includegraphics[scale=0.5] {./images/nyancat.png}}\end{beamercolorbox}}
\begin{frame}
\begin{center}
\Huge{Conclusion}
\end{center}
